...
sys_page_alloc(envid_t envid, void *va, int perm)
{
	...
	//panic("sys_page_alloc not implemented");
        ...
        if ((r = page_insert(env->env_pgdir, page, va, perm))) {
                page_free(page);
                return r;
        }
	     ...
	     envid_t dstenvid, void *dstva, int perm)
{
	...
	//panic("sys_page_map not implemented");
        ...
        if ((r = page_insert(dstenv->env_pgdir, page, dstva, perm)))
                return r;
...
#define IPC_VA_INVAL(va) ((((uintptr_t) (va)) < UTOP ) && ((((uintptr_t)(va)) & (PGSIZE-1)) != 0))
...
*/
    ...
    if ((uintptr_t)srcva < UTOP) {
        ...
        if (!(page = page_lookup(srcenv->env_pgdir, srcva, &ptep))) {
            return -E_INVAL;
        }
        ...
        if ((r = page_insert(dstenv->env_pgdir, page,
...
*/
    //cprintf("env %x recv\n", e->env_id);
/*
    if (IPC_VA_INVAL(dstva))
        return -E_INVAL;
    }*/
    if ((((uintptr_t) (dstva)) < UTOP ) 
        && ((((uintptr_t)(dstva)) & (PGSIZE-1)) != 0))
        return -E_INVAL;
